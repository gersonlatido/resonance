...
<head>
  ...
  <title>Sales and Stock Reports</title>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .money{ font-weight: 900; color: var(--orange-2); }
    ...
    <main class="content">
      ...
      <div class="header">
        <div class="header-left">
          <h1 class="title">Sales and Stock Reports</h1>
          <div class="subtitle">Sales (paid orders) + current inventory status (low stock warnings)</div>
        </div>
      ...
      <div class="filter">
        ...
        <form method="GET" action="{{ route('admin.sales-stock-reports') }}">
          ...
          <a class="btn" href="{{ route('admin.sales-stock-reports.print', ['period'=>$period, 'date'=>$selectedDate]) }}">
  Download PDF
</a>

<a class="btn" href="{{ route('admin.sales-stock-reports.export.csv', ['period'=>$period, 'date'=>$selectedDate]) }}">
  Download CSV
</a>
        </form>
      </div>
      ...
      <!-- Stats -->
      <section class="stats" aria-label="Sales and stock stats">
        <div class="stat">
          <div>
        ...
        <!-- ✅ FIXED: use $lowStockCount consistently -->
        <div class="stat">
          <div>
            <div class="label">Low Stock Items</div>
            <div class="value {{ $lowStockCount > 0 ? 'danger' : 'oktxt' }}">
              {{ $lowStockCount }}
            </div>
          </div>
        </div>
      ...
      <section class="grid">
        ...
        <div class="card">
          ...
          <div style="padding: 12px 14px;">
            ...
            @else
              <div class="oktxt">✅ All ingredients are above reorder level.</div>
            @endif
          </div>
        </div>
