...
<body>
   ...
   <div class="drinks-category"><h2>Frappuccino Blended Beverages</h2></div>
           <div class="frappuccino-container">
            ...
            <div class="drinks-category"><h2>Coffee Based Beverages</h2></div>
          <div class="coffee-based-container">
                <!-- <div class="menu-item">
                    <div class="menu-item-image"><img src="/images/all-day-breakfast-entrees/beefsilog.png" alt=""></div>
                    <div class="menu-item-details">
                        <h3 class="menu-item-name">BEEFSILOG</h3>
             ...
             <div class="drinks-category"><h2>Milk Based Beverages</h2></div>
            <div class="milk-based-container">
                <!-- <div class="menu-item">
                    <div class="menu-item-image"><img src="/images/all-day-breakfast-entrees/beefsilog.png" alt=""></div>
                    <div class="menu-item-details">
                        <h3 class="menu-item-name">BEEFSILOG</h3>
